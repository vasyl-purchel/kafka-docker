...
RUN wget http://www.eu.apache.org/dist/kafka/0.9.0.0/kafka_2.10-0.9.0.0.tgz \
    && wget http://www.eu.apache.org/dist/kafka/0.9.0.0/kafka_2.10-0.9.0.0.tgz.md5 \
    && md5sum kafka_2.10-0.9.0.0.tgz \
    && tar xzf kafka_2.10-0.9.0.0.tgz -C /opt \
